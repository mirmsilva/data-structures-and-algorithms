...
//create answer array
let answer = [];
//using forEach and Math.pow raise each element to the 3rd power
arr.forEach((i) => (answer.push(Math.pow(i,3))))
//return answer
return answer;
};
...
const addOne = (arr) => {
  // create answer array
  let answer = [];
  // using map return new array with all elements +1
  arr.map(num=>answer.push(num+1));
  //return answer
  return answer;
};
...
const addQuestion = (arr) => {
  //create answer array
  let answer = [];
  //use map to add a "?" to the end of each element. Push into asnwer array
  arr.map(string => (answer.push(string +'?')))
  //return answer array
  return answer;
};
...
const forLoopTwoToThe = (arr) => {
  //create answer array
  let answer = [];
  //create a for loop the raises 2 by the element in the array. push into answer.
  for (let i of arr){
...
const forEachTwoToThe = (arr) => {
  ...
  let answer = [];
  // using forEach raise 2 to the the power of each element. push into answer
...
const mapTwoToThe = (arr) => {
  //create answer array
  let answer = [];
  //use map to loop through each array and raise 2 to the power of each element. Push into answer array
  arr.map((i)=>(answer.push(Math.pow(2,i))))
  //return answer
  return answer;
